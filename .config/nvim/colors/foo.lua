-- based on the default vim colour scheme
-- mostly white text on black background
-- uses bold text for highlighting a lot, refrains from using
-- colours much
--
-- This is hacked together until my C++ code looked fine, no
...
hi('@lsp.type.variable',      { link = 'Identifier' })
  ...
  hi('TSKeyword', { fg = 'White' })
  hi('TSComment', { fg = 'LightGrey' })
  hi('TSString', { fg = 'LightGrey' })
  ...
  hi('LineNr',       { fg = 'DarkGrey',                               ctermfg = 'Brown' })
  hi('MatchParen',   { fg = 'Green', bg = 'LightGrey' })
  hi('MoreMsg',      { fg = 'SeaGreen', bold = true,               ctermfg = 'DarkGreen' })
  hi('Pmenu',        { bg = 'Black',                        ctermfg = 'Black', ctermbg = 'LightMagenta' })
  ...
  hi('Comment',      { fg = 'DarkGrey',                                ctermfg = 'DarkBlue' })
  hi('Constant',     { fg = 'White',                             ctermfg = 'DarkRed' })
  hi('Special',      { fg = 'White', bold = true,                             ctermfg = 'DarkMagenta' })
  hi('Identifier',   { fg = 'White',                            ctermfg = 'DarkCyan' })
  hi('Statement',    { fg = 'White', bold = true,                  ctermfg = 'White' })
  hi('PreProc',      { fg = 'LightBlue',                             ctermfg = 'Blue' })
  hi('Type',         { fg = 'White', bold = true,               ctermfg = 'Black' })
